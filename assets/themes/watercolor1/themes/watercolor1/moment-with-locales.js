;(function (global, factory) {
    ...
    hooks.defineLocale('ar-sa', {
        ...
        preparse: function (string) {
            return string
                .replace(/[١٢٣٤٥٦٧٨٩� ]/g, function (match) {
    ...
    hooks.defineLocale('bo', {
        ...
        weekdays: 'གཟ� ་ཉི་མ་_གཟ� ་ཟླ་བ་_གཟ� ་མིག་དམར་_གཟ� ་ལྷག་པ་_གཟ� ་ཕུར་བུ_གཟ� ་པ་སངས་_གཟ� ་སྤེན་པ་'.split(
            '_'
        ),
    ...
    hooks.defineLocale('el', {
        ...
        weekdays: 'Κυριακή_Δευτέρα_Τρίτη_Τετάρτη_� έμπτη_� αρασκευή_Σάββατο'.split(
            '_'
        ),
    ...
    var months$7 = [
        ...
        weekdaysMin$1 = ['Dò', 'Lu', 'M� ', 'Ci', 'Ar', 'Ha', 'Sa'];
    ...
    hooks.defineLocale('he', {
        months: 'י� ואר_פברואר_מרץ_אפריל_מאי_יו� י_יולי_אוגוסט_ספטמבר_אוקטובר_� ובמבר_דצמבר'.split(
            '_'
        ),
        monthsShort: 'י� ו׳_פבר׳_מרץ_אפר׳_מאי_יו� י_יולי_אוג׳_ספט׳_אוק׳_� וב׳_דצמ׳'.split(
            '_'
        ),
        ...
        meridiemParse: /אחה"צ|לפ� ה"צ|אחרי הצהריים|לפ� י הצהריים|לפ� ות בוקר|בבוקר|בערב/i,
        isPM: function (input) {
        ...
        meridiem: function (hour, minute, isLower) {
            if (hour < 5) {
                ...
                return isLower ? 'לפ� ה"צ' : 'לפ� י הצהריים';
            } else if (hour < 18) {
    ...
    hooks.defineLocale('ka', {
        months: 'იანვა� ი_თებე� ვალი_მა� ტი_აპ� ილი_მაისი_ივნისი_ივლისი_აგვისტო_სექტემბე� ი_ოქტომბე� ი_ნოემბე� ი_დეკემბე� ი'.split(
            '_'
        ),
        monthsShort: 'იან_თებ_მა� _აპ� _მაი_ივნ_ივლ_აგვ_სექ_ოქტ_ნოე_დეკ'.split('_'),
        weekdays: {
            standalone: 'კვი� ა_ო� შაბათი_სამშაბათი_ოთხშაბათი_ხუთშაბათი_პა� ასკევი_შაბათი'.split(
                '_'
            ),
            format: 'კვი� ას_ო� შაბათს_სამშაბათს_ოთხშაბათს_ხუთშაბათს_პა� ასკევს_შაბათს'.split(
                '_'
            ),
    ...
    hooks.defineLocale('km', {
        months: 'មករា_កុម្ភៈ_មីនា_មេសា_ឧសភា_មិថុនា_កក្កដា_សី� ា_កញ្ញា_តុលា_វិច្ឆិកា_ធ្នូ'.split(
            '_'
        ),
        monthsShort: 'មករា_កុម្ភៈ_មីនា_មេសា_ឧសភា_មិថុនា_កក្កដា_សី� ា_កញ្ញា_តុលា_វិច្ឆិកា_ធ្នូ'.split(
            '_'
        ),
    ...
    hooks.defineLocale('mt', {
        months: 'Jannar_Frar_Marzu_April_Mejju_� unju_Lulju_Awwissu_Settembru_Ottubru_Novembru_Diċembru'.split(
            '_'
        ),
        monthsShort: 'Jan_Fra_Mar_Apr_Mej_� un_Lul_Aww_Set_Ott_Nov_Diċ'.split('_'),
        weekdays: 'Il-Ħadd_It-Tnejn_It-Tlieta_L-Erbgħa_Il-Ħamis_Il-� imgħa_Is-Sibt'.split(
            '_'
        ),
        weekdaysShort: 'Ħad_Tne_Tli_Erb_Ħam_� im_Sib'.split('_'),
        weekdaysMin: 'Ħa_Tn_Tl_Er_Ħa_� i_Si'.split('_'),
        longDateFormat: {
            LT: 'HH:mm',
            LTS: 'HH:mm:ss',
            L: 'DD/MM/YYYY',
    ...
    hooks.defineLocale('th', {
        months: 'มกราคม_กุม� าพันธ์_มีนาคม_เมษายน_พฤษ� าคม_มิถุนายน_กรกฎาคม_สิงหาคม_กันยายน_ตุลาคม_พฤศจิกายน_ธันวาคม'.split(
            '_'
        ),
